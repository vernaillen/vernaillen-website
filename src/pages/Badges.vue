<template>
  <q-page padding class="max1024">
    <p>
      ...
      <a href="https://circleci.com/gh/vernaillen/vernaillen-website" rel="nofollow"><img alt="CircleCI" src="https://badgen.net/circleci/github/vernaillen/vernaillen-website?icon=circleci&color=blue"></a>
    </p>
  </q-page>
</template>
